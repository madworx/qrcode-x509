#!/usr/bin/env python3
"""
QR Code Certificate Validator
Scans QR codes and validates certificates against CA
"""
...
class CertificateValidator:
    ...
    def validate_qr_image(self, image_path):
        ...
        # Decode QR code
        cert_pem = self.decode_qr_image(image_path)
        print(f"QR code decoded successfully ({len(cert_pem)} characters)")
...
def main():
    parser = argparse.ArgumentParser(description='Validate certificate from QR code')
